...
@Service(version = "${zhcx.business.dubbo.version}",interfaceClass = AccountInfoDubboService.class)
public class AccountInfoDubboServiceImpl implements AccountInfoDubboService {
