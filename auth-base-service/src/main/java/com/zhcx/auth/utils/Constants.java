...
public class Constants {
	...
	//企业用户
	public static final String AUTH_USER_TYPE_COMPANY = "03";
	...
	public static final String DEAULT_CITY_NAME = "邵阳市";

	public static final String DEAULT_NET_CAR_CITY_NAME = "邵阳市";
