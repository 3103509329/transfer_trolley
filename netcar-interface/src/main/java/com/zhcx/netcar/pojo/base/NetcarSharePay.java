...
public class NetcarSharePay extends NetcarBasePojo implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        NetcarSharePay other = (NetcarSharePay) that;
        return (this.getCompanyId() == null ? other.getCompanyId() == null : this.getCompanyId().equals(other.getCompanyId()))
            ...
            && (this.getDriverMile() == null ? other.getDriverMile() == null : this.getDriverMile().equals(other.getDriverMile()))
            ...
            && (this.getShareFuelFee() == null ? other.getShareFuelFee() == null : this.getShareFuelFee().equals(other.getShareFuelFee()))
            && (this.getShareHighwayToll() == null ? other.getShareHighwayToll() == null : this.getShareHighwayToll().equals(other.getShareHighwayToll()))
            && (this.getPassengerTip() == null ? other.getPassengerTip() == null : this.getPassengerTip().equals(other.getPassengerTip()))
            && (this.getShareOther() == null ? other.getShareOther() == null : this.getShareOther().equals(other.getShareOther()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getDriverMile() == null) ? 0 : getDriverMile().hashCode());
        ...
        result = prime * result + ((getShareFuelFee() == null) ? 0 : getShareFuelFee().hashCode());
        result = prime * result + ((getShareHighwayToll() == null) ? 0 : getShareHighwayToll().hashCode());
        result = prime * result + ((getPassengerTip() == null) ? 0 : getPassengerTip().hashCode());
        result = prime * result + ((getShareOther() == null) ? 0 : getShareOther().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", driverMile=").append(driverMile);
        ...
        sb.append(", shareFuelFee=").append(shareFuelFee);
