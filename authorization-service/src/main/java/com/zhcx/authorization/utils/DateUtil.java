...
public class DateUtil extends DateUtils {
	...
	private final static SimpleDateFormat formatYYYY = new SimpleDateFormat(FORMAT_yyyy);
	 ...
	 * 获取指定日期偏移天数日期
	 * @param time
	 * @param offsets   1：当前后一天，-1：当前天前一天
	 */
	public static String getOffsetsDay(String time,int offsets) {
		...
		calendar.set(Calendar.DATE, day + offsets);
    ...
    public static String getPastYear() {
		...
		return formatYYYY.format(c.getTime());
    }
}
